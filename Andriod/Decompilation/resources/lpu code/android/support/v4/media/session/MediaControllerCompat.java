...
public final class MediaControllerCompat
{
    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
    ...
    private void processPendingCallbacks()
    {
      ...
      MediaControllerCompat.Callback localCallback;
      ExtraCallback localExtraCallback;
      synchronized (this.mPendingCallbacks)
      {
        Iterator localIterator = this.mPendingCallbacks.iterator();
        if (localIterator.hasNext())
        {
          localCallback = (MediaControllerCompat.Callback)localIterator.next();
          localExtraCallback = new ExtraCallback(localCallback);
    ...
    public final void registerCallback(MediaControllerCompat.Callback paramCallback, Handler arg2)
    {
      ...
      synchronized (this.mPendingCallbacks)
      {
        paramCallback.mHasExtraCallback = false;
    ...
    public final void unregisterCallback(MediaControllerCompat.Callback paramCallback)
    {
      ...
      if (this.mExtraBinder != null) {
        try
        {
          ??? = (ExtraCallback)this.mCallbackMap.remove(paramCallback);
          if (??? != null)
          {
            paramCallback.mHasExtraCallback = false;
            this.mExtraBinder.unregisterCallbackListener((IMediaControllerCallback)???);
          }
          return;
        }
        catch (RemoteException paramCallback)
...
/* Location:              C:\Users\ankit\Documents\GitHub\code-with-ankit\Andriod\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\media\session\MediaControllerCompat.class
