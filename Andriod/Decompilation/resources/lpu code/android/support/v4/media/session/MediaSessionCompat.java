  ...
  public static abstract class Callback
  {
    ...
    public boolean onMediaButtonEvent(Intent paramIntent)
    {
      ...
      for (;;)
      {
        ...
        if (paramIntent == null) {}
        for (long l = 0L; (0x20 & l) != 0L; l = paramIntent.getActions())
        {
          onSkipToNext();
          return true;
        }
...
/* Location:              C:\Users\ankit\Documents\GitHub\code-with-ankit\Andriod\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\media\session\MediaSessionCompat.class
