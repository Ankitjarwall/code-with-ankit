  ...
  extends IInterface
{
    ...
    implements IMediaSession
  {
      ...
      throws RemoteException
    {
      ...
      case 38: 
        paramParcel1.enforceInterface("android.support.v4.media.session.IMediaSession");
        bool = isShuffleModeEnabledRemoved();
        paramParcel2.writeNoException();
        paramInt1 = m;
        if (bool) {
          paramInt1 = 1;
      ...
      case 51: 
        ...
        for (paramParcel1 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; paramParcel1 = null)
        {
          rateWithExtras((RatingCompat)localObject, paramParcel1);
          paramParcel2.writeNoException();
          return true;
          localObject = null;
          break;
      ...
      case 40: 
        ...
        for (bool = true;; bool = false)
        {
          setShuffleModeEnabledRemoved(bool);
          paramParcel2.writeNoException();
          return true;
        }
      case 48: 
      ...
      implements IMediaSession
    {
        ...
        throws RemoteException
      {
        ...
        //   25: aload_2
        //   26: aload_1
        //   27: invokevirtual 179	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
        //   30: aload_0
...
/* Location:              C:\Users\ankit\Documents\GitHub\code-with-ankit\Andriod\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\media\session\IMediaSession.class
