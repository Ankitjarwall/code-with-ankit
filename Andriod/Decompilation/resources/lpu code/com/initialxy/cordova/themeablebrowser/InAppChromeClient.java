  ...
  public boolean onJsPrompt(WebView paramWebView, String paramString1, String paramString2, String paramString3, JsPromptResult paramJsPromptResult)
  {
    if ((paramString3 != null) && (paramString3.startsWith("gap"))) {
      if (paramString3.startsWith("gap-iab://"))
      {
        ...
        if (paramString1.startsWith("ThemeableBrowser"))
        {
      ...
      {
        LOG.w(this.LOG_TAG, "ThemeableBrowser does not support Cordova API calls: " + paramString1 + " " + paramString3);
...
/* Location:              C:\Users\ankit\Documents\GitHub\code-with-ankit\Andriod\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\com\initialxy\cordova\themeablebrowser\InAppChromeClient.class
