...
class zzh
{
  ...
  public zzh(Context paramContext, String paramString)
  {
    ...
    this.zzbif = paramContext.getSharedPreferences(paramString, 0);
  ...
  private String zzaz(String paramString1, String paramString2)
  {
  ...
  {
    SharedPreferences.Editor localEditor = this.zzbif.edit();
    Iterator localIterator = this.zzbif.getAll().keySet().iterator();
  ...
  private String zzt(String paramString1, String paramString2, String paramString3)
  {
  ...
  public boolean isEmpty()
  {
    try
    {
      boolean bool = this.zzbif.getAll().isEmpty();
      return bool;
    }
    finally
    {
  ...
  public void zza(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    ...
    //   9: invokestatic 188	com/google/firebase/iid/zzh$zza:zzd	(Ljava/lang/String;Ljava/lang/String;J)Ljava/lang/String;
    //   12: astore 4
    //   14: aload 4
    //   16: ifnonnull +6 -> 22
    //   19: aload_0
    ...
    //   21: return
    //   22: aload_0
    //   23: getfield 32	com/google/firebase/iid/zzh:zzbif	Landroid/content/SharedPreferences;
    ...
    //   37: aload_2
    //   38: aload_3
    //   39: invokespecial 190	com/google/firebase/iid/zzh:zzt	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   42: aload 4
  ...
  public KeyPair zzeI(String paramString)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 32	com/google/firebase/iid/zzh:zzbif	Landroid/content/SharedPreferences;
    //   6: aload_0
    //   7: aload_1
    //   8: ldc -52
    //   10: invokespecial 206	com/google/firebase/iid/zzh:zzaz	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   13: aconst_null
    //   14: invokeinterface 209 3 0
    //   19: astore_2
    //   20: aload_0
    //   21: getfield 32	com/google/firebase/iid/zzh:zzbif	Landroid/content/SharedPreferences;
    //   24: aload_0
    //   25: aload_1
    //   26: ldc -45
    //   28: invokespecial 206	com/google/firebase/iid/zzh:zzaz	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   31: aconst_null
    ...
    //   147: pop
    //   148: aload_0
    //   149: getfield 24	com/google/firebase/iid/zzh:zzqn	Landroid/content/Context;
    //   152: aload_0
    //   153: invokestatic 109	com/google/firebase/iid/FirebaseInstanceId:zza	(Landroid/content/Context;Lcom/google/firebase/iid/zzh;)V
    //   156: aconst_null
    //   157: astore_1
    //   158: goto -110 -> 48
    //   161: astore_1
  ...
  public void zzi(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      paramString1 = zzt(paramString1, paramString2, paramString3);
      paramString2 = this.zzbif.edit();
  ...
  /* Error */
  public long zzjy(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   3: aload_1
    //   4: ldc_w 263
    //   7: invokespecial 206	com/google/firebase/iid/zzh:zzaz	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   10: astore_1
    //   11: aload_0
    //   12: getfield 32	com/google/firebase/iid/zzh:zzbif	Landroid/content/SharedPreferences;
    //   15: aload_1
    //   16: aconst_null
  ...
  KeyPair zzjz(String paramString)
  {
    try
    {
      KeyPair localKeyPair = zza.zzHg();
      long l = System.currentTimeMillis();
      SharedPreferences.Editor localEditor = this.zzbif.edit();
      localEditor.putString(zzaz(paramString, "|P|"), FirebaseInstanceId.zzv(localKeyPair.getPublic().getEncoded()));
      localEditor.putString(zzaz(paramString, "|K|"), FirebaseInstanceId.zzv(localKeyPair.getPrivate().getEncoded()));
      localEditor.putString(zzaz(paramString, "cre"), Long.toString(l));
      localEditor.commit();
      return localKeyPair;
    }
    finally
  ...
  public zza zzu(String paramString1, String paramString2, String paramString3)
  {
    try
    {
      paramString1 = zza.zzjA(this.zzbif.getString(zzt(paramString1, paramString2, paramString3), null));
      return paramString1;
    }
    finally
    {
  ...
  static class zza
  {
    private static final long zzclH = TimeUnit.DAYS.toMillis(7L);
    ...
    {
      this.zzbxW = paramString1;
      this.zzbhN = paramString2;
      this.timestamp = paramLong;
    }
    
    static String zzd(String paramString1, String paramString2, long paramLong)
    {
      try
      {
    ...
    static zza zzjA(String paramString)
    {
    ...
    boolean zzjB(String paramString)
    {
      return (System.currentTimeMillis() > this.timestamp + zzclH) || (!paramString.equals(this.zzbhN));
    }
  }
}


/* Location:              C:\Users\ankit\Documents\GitHub\code-with-ankit\Andriod\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\com\google\firebase\iid\zzh.class
