  ...
  implements MultipleBarcodeReader
{
  ...
  private static List<Result> processStructuredAppend(List<Result> paramList)
  {
    ...
    } while (!((Result)((Iterator)localObject1).next()).getResultMetadata().containsKey(ResultMetadataType.STRUCTURED_APPEND_SEQUENCE));
    int i = 1;
    if (i == 0) {
      return paramList;
    }
    ...
    while (((Iterator)localObject2).hasNext())
    {
      ...
      System.arraycopy(((Result)localObject5).getRawBytes(), 0, localObject4, j, ((Result)localObject5).getRawBytes().length);
      int n = j + ((Result)localObject5).getRawBytes().length;
      j = n;
...
/* Location:              C:\Users\ankit\Documents\GitHub\code-with-ankit\Andriod\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\com\google\zxing\multi\qrcode\QRCodeMultiReader.class
