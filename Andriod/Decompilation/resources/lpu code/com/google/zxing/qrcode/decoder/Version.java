...
public final class Version
{
  ...
  private Version(int paramInt, int[] paramArrayOfInt, ECBlocks... paramVarArgs)
  {
    ...
    int j = 0;
    int k = paramVarArgs[0].getECCodewordsPerBlock();
    ...
    while (paramInt < m)
    {
      ...
      i += paramVarArgs.getCount() * (paramVarArgs.getDataCodewords() + k);
      paramInt += 1;
    }
...
/* Location:              C:\Users\ankit\Documents\GitHub\code-with-ankit\Andriod\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\com\google\zxing\qrcode\decoder\Version.class
