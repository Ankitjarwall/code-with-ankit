  ...
  extends zzbyu
{
  ...
  zzbyz(zzbyr paramzzbyr, int paramInt)
  {
    ...
    while (i < paramInt)
    {
      ...
      int k = paramzzbyr.limit - paramzzbyr.pos + i;
      i = k;
      if (k > paramInt) {
        i = paramInt;
      }
  ...
  public int hashCode()
  {
    ...
    {
      byte[] arrayOfByte = this.zzcyf[k];
      int i1 = this.zzcyg[(i2 + k)];
      n = this.zzcyg[k];
      int j = i1;
      while (j < i1 + (n - m))
      {
...
/* Location:              C:\Users\ankit\Documents\GitHub\code-with-ankit\Andriod\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\internal\zzbyz.class
