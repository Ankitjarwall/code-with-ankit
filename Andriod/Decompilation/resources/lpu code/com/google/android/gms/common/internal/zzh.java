...
public final class zzh
{
  ...
  @Nullable
  private static String zzC(Context paramContext, String paramString)
  {
    int i;
    synchronized (zzaFE)
    {
  ...
  public static String zzg(Context paramContext, int paramInt)
  {
    ...
    case 7: 
      ...
      return zzC(paramContext, "common_google_play_services_network_error_title");
    case 8: 
    ...
    case 5: 
      ...
      return zzC(paramContext, "common_google_play_services_invalid_account_title");
    case 11: 
    ...
    case 17: 
      ...
      return zzC(paramContext, "common_google_play_services_sign_in_failed_title");
    }
    Log.e("GoogleApiAvailability", "The current user profile is restricted and could not use authenticated features.");
    return zzC(paramContext, "common_google_play_services_restricted_profile_title");
  }
  ...
  {
    if (paramInt == 6) {}
    for (String str1 = zzC(paramContext, "common_google_play_services_resolution_required_title");; str1 = zzg(paramContext, paramInt))
    {
      String str2 = str1;
      if (str1 == null) {
  ...
  {
    Resources localResources = paramContext.getResources();
    paramString1 = zzC(paramContext, paramString1);
...
/* Location:              C:\Users\ankit\Documents\GitHub\code-with-ankit\Andriod\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\common\internal\zzh.class
