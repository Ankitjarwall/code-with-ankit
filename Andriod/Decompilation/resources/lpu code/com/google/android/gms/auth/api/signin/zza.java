  ...
  implements Parcelable.Creator<GoogleSignInAccount>
{
  static void zza(GoogleSignInAccount paramGoogleSignInAccount, Parcel paramParcel, int paramInt)
  {
    ...
    zzc.zza(paramParcel, 8, paramGoogleSignInAccount.zzre());
    zzc.zza(paramParcel, 9, paramGoogleSignInAccount.zzrf(), false);
    zzc.zzc(paramParcel, 10, paramGoogleSignInAccount.zzaiN, false);
  ...
  public GoogleSignInAccount zzW(Parcel paramParcel)
  {
  ...
  public GoogleSignInAccount[] zzbl(int paramInt)
  {
...
/* Location:              C:\Users\ankit\Documents\GitHub\code-with-ankit\Andriod\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\auth\api\signin\zza.class
