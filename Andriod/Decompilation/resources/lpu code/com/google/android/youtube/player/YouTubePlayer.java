...
public abstract interface YouTubePlayer
{
  ...
  public static enum ErrorReason
  {
    static
    {
      ...
      PLAYER_VIEW_NOT_VISIBLE = new ErrorReason("PLAYER_VIEW_NOT_VISIBLE", 6);
      EMPTY_PLAYLIST = new ErrorReason("EMPTY_PLAYLIST", 7);
      AUTOPLAY_DISABLED = new ErrorReason("AUTOPLAY_DISABLED", 8);
      USER_DECLINED_RESTRICTED_CONTENT = new ErrorReason("USER_DECLINED_RESTRICTED_CONTENT", 9);
      USER_DECLINED_HIGH_BANDWIDTH = new ErrorReason("USER_DECLINED_HIGH_BANDWIDTH", 10);
      UNEXPECTED_SERVICE_DISCONNECTION = new ErrorReason("UNEXPECTED_SERVICE_DISCONNECTION", 11);
    }
...
/* Location:              C:\Users\ankit\Documents\GitHub\code-with-ankit\Andriod\Decompilation\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\youtube\player\YouTubePlayer.class
